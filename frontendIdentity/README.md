...
## Install process
  ...
  Build the ubuntu image in a repository:
      ...
      sudo docker build -t frontendidentity  <PATHL>

  Run ubuntu: 
      
      sudo docker run -it --network TokPhyAppNetwork -p 5510:5510  -v  <PATHL>:/frontendidentity  frontendidentity
      

  Then, go to the path:
      
      cd /frontendidentity/frontendIdentityApp
...
## Deployment
  ...
  Identify the container id of **frontendidentity** and set the following command:
    
    sudo docker start <containerid>

  Go into container **frontendidentity** by executing the following:

...
async function createBCdentitySC(req) {
	...
	const BirthCertificate = req.body.BirthCertificate;
	...
	try {
		...
		await new Promise(async (resolve, reject) => {
			...
			try {
				...
				const contractAnswer = await userContract.deploy({ data: contractByteCodeObj, arguments: [BirthCertificate,studentID ] }).send(
